...
export default class HomeScreen extends Component {
  ...
  render() {
    return ( <View style={{flex:1}}>
        <View style={[{flex:0.1,backgroundColor:'rgb(68,35,124)',marginBottom:10},styles.flexcontentmiddle]}>
            <Text style={[{fontSize:20},styles.textstyles]}>Create a profile</Text>
        </View>
        <View style={{flex:0.8}}>
